  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <h1 className="text-4xl md:text-5xl font-bold mt-2 text-zinc-100">
          Your Ultimate Goal
        </h1>
      ...
      <section className="relative group">
        <textarea
          ...
          className="w-full bg-zinc-900/30 text-2xl md:text-3xl font-serif leading-relaxed text-zinc-200 placeholder:text-zinc-700 border-l-4 border-amber-500/20 focus:border-amber-500 outline-none p-6 md:p-8 min-h-[300px] resize-none rounded-r-lg transition-all duration-300 focus:bg-zinc-900/50"
          spellCheck={false}
        />
